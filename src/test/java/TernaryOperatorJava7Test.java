...
/**
 * Test-cases for the ternary operator.
 *
 * @author <a href="mailto:jhunovis@gmail.com">Jan Hackel</a>
 * @version $Revision$ $Date$ $Author$
 */
@SuppressWarnings("ConstantConditionalExpression")
public class TernaryOperatorJava7Test {
    ...
    */
    ...
    /**
     * This works because {@link java.io.PrintStream#println(Object)} will be used in the following example!
     */
    @Test
    public void testDynamicOverloadingSelection() throws Exception {
        System.out.println(true ? 21 : "Zebra");
        System.out.println(false ? 21 : "Zebra");
    }
}
